...
{
   mysql $default_args -e "select \"$args\",gmt_create,event,value1,value2,value3,value4  from __all_rootservice_event_history  order by gmt_create desc  limit 5"
...
function check_mem
{
   ...
   mysql $default_args  -e "select \"$args\",ACTIVE*100/FREEZE_TRIGGER as active_per,total/1024/1024/1024 as total_g,FREEZE_TRIGGER/1024/1024/1024 as trigger_g,mem_limit/1024/1024/1024 as limit_g, total*100/MEM_LIMIT as percent ,tenant_id,ip from gv\$memstore order by percent desc  limit 10;"
}
