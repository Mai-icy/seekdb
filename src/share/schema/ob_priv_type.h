...
enum OB_PRIV_SHIFT
{
  ...
  OB_PRIV_LOCK_TABLE_SHIFT,
  OB_PRIV_CREATE_SENSITIVE_RULE_SHIFT,
  OB_PRIV_PLAINACCESS_SHIFT,
  OB_PRIV_CREATE_AI_MODEL_SHIFT,
  OB_PRIV_ALTER_AI_MODEL_SHIFT,
  OB_PRIV_DROP_AI_MODEL_SHIFT,
  OB_PRIV_ACCESS_AI_MODEL_SHIFT,
...
#define OB_PRIV_ALL                                                             \
  (OB_PRIV_ALTER | OB_PRIV_CREATE | OB_PRIV_CREATE_USER | OB_PRIV_DELETE |      \
   ...
   OB_PRIV_SUPER | OB_PRIV_PROCESS | OB_PRIV_FILE | OB_PRIV_ALTER_SYSTEM |     \
   ...
   OB_PRIV_TRIGGER | OB_PRIV_LOCK_TABLE |                                       \
...
enum OB_PRIV_OTHERS_TYPE
{
  ...
  OB_PRIV_OTHERS_CREATE_AI_MODEL = (1LL << 11),
  OB_PRIV_OTHERS_ALTER_AI_MODEL = (1LL << 12),
  OB_PRIV_OTHERS_DROP_AI_MODEL = (1LL << 13),
  OB_PRIV_OTHERS_ACCESS_AI_MODEL = (1LL << 14)
};
