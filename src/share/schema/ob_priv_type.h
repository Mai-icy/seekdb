...
enum OB_PRIV_SHIFT
{
  ...
  OB_PRIV_LOCK_TABLE_SHIFT =            44,
  OB_PRIV_ENCRYPT_SHIFT =               45,
  OB_PRIV_DECRYPT_SHIFT =               46,
  OB_PRIV_PROXY_SHIFT =                 47,
  OB_PRIV_EVENT_SHIFT =                 48,
  OB_PRIV_CREATE_CATALOG_SHIFT =        49,
  OB_PRIV_USE_CATALOG_SHIFT =           50,
  OB_PRIV_CREATE_LOCATION_SHIFT =       51,
  OB_PRIV_CREATE_SENSITIVE_RULE_SHIFT = 52,
  OB_PRIV_PLAINACCESS_SHIFT =           53,
  OB_PRIV_CREATE_AI_MODEL_SHIFT =       54,
  OB_PRIV_ALTER_AI_MODEL_SHIFT =        55,
  OB_PRIV_DROP_AI_MODEL_SHIFT =         56,
  OB_PRIV_ACCESS_AI_MODEL_SHIFT =       57,
