...
#include "lib/utility/ob_fast_convert.h"  // ObFastFormatInt, previously hidden behind a transitive include
#include "lib/utility/ob_sort.h"  // lib::ob_sort, previously hidden behind a transitive include
#include "lib/charset/ob_charset.h"  // ObCharset, previously hidden behind a transitive include
