...
#include "lib/container/ob_array.h"  // ObArray, previously hidden behind the log_service include chain
#include "objit/common/ob_item_type.h"  // ObItemType/T_FUN_SYS_*(objit/common is already L1), previously hidden behind a transitive include
#include "ob_rb_bin.h"
