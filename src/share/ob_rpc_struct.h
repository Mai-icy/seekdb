...
#ifdef OB_BUILD_SHARED_STORAGE
struct ObCallRemoteWriteDDLFinishLogArg final
{
  OB_UNIS_VERSION(1);
public:
  ObCallRemoteWriteDDLFinishLogArg();
  ~ObCallRemoteWriteDDLFinishLogArg() = default;
...
private:
  DISALLOW_COPY_AND_ASSIGN(ObCallRemoteWriteDDLFinishLogArg);
};
