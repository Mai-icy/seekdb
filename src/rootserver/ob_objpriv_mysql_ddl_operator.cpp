...
int ObObjPrivMysqlDDLOperator::drop_obj_mysql_privs(const ObString &obj_name,
                               ...
                               ObSchemaGetterGuard &schema_guard)
{
  ...
  OZ (schema_guard.get_obj_mysql_priv_with_obj_name( obj_name, obj_type, obj_privs, true));
