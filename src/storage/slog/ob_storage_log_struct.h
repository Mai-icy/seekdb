...
enum class ObRedoLogMainType
{
  ...
  OB_REDO_LOG_SYS = 1,
  OB_REDO_LOG_LOCAL_STORAGE = 2,
  OB_REDO_LOG_SERVER_RUNTIME = 3,
  OB_REDO_LOG_MAX = 4
};
...
enum class ObRedoLogSubType
{
  ...
  OB_REDO_LOG_CREATE_RUNTIME_PREPARE = 2,
  OB_REDO_LOG_CREATE_RUNTIME_COMMIT = 3,
  OB_REDO_LOG_CREATE_RUNTIME_ABORT = 4,
  OB_REDO_LOG_UPDATE_SERVER_RESOURCES = 7,
  OB_REDO_LOG_UPDATE_RUNTIME_SUPER_BLOCK = 8,

  OB_REDO_LOG_UPDATE_LS = 12,

  OB_REDO_LOG_DELETE_TABLET = 14,
