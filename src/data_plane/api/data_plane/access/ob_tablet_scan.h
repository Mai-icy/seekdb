...
#ifndef OCEANBASE_DATA_PLANE_ACCESS_OB_TABLET_SCAN_H_
#define OCEANBASE_DATA_PLANE_ACCESS_OB_TABLET_SCAN_H_
...
// Virtual tables and persisted tablets share the scan protocol, but are
// provided by different runtime services. Keep a distinct service type so
// callers cannot accidentally route a virtual-table scan to Storage.
class ObIVirtualTableScan : public ObITabletScan
{
};
}
}
#endif /* OCEANBASE_DATA_PLANE_ACCESS_OB_TABLET_SCAN_H_ */
