...
#include "lib/utility/ob_smart_call.h"  // previously hidden behind the ob_server.h include chain,make the dependency explicit
#include "sql/engine/ob_operator.h"  // previously hidden behind the ob_server.h include chain,make the dependency explicit
