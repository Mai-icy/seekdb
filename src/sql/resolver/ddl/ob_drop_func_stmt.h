...
public:
  ...
  obcall::ObDropUserDefinedFunctionArg &get_drop_func_arg() { return drop_func_arg_; }
  obcall::ObDDLArg &get_ddl_arg() { return drop_func_arg_; }
  TO_STRING_KV(K_(drop_func_arg));
private:
  obcall::ObDropUserDefinedFunctionArg drop_func_arg_;
