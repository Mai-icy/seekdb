...
public:
  ...
  int execute_refresh(sql::ObExecContext *ctx,
                      common::ObIAllocator *allocator,
                      const ObVectorRefreshIndexArg &arg);
  int execute_refresh_inner(sql::ObExecContext *ctx,
                            common::ObIAllocator *allocator,
                            const ObVectorRefreshIndexInnerArg &arg);
  int execute_rebuild(sql::ObExecContext *ctx,
                      common::ObIAllocator *allocator,
                      const ObVectorRebuildIndexArg &arg);
  int execute_rebuild_inner(sql::ObExecContext *ctx,
                            common::ObIAllocator *allocator,
