...
public:
  ...
  int update_table_stat(sqlclient::ObISQLConnection *conn,
                        ...
                        const bool is_index_stat);
  int batch_get_column_stats(const uint64_t table_id,
                             const ObIArray<int64_t> &part_ids,
  ...
  int get_column_stat(const uint64_t table_id,
                      const ObIArray<int64_t> &part_ids,
  ...
  int get_column_stat(const uint64_t ref_id,
                      const int64_t part_id,
                      const uint64_t col_id,
                      ObOptColumnStatHandle &handle);

  int get_table_stat(const uint64_t table_ref_id,
                     const int64_t part_id,
                     const double scale_ratio,
                     ObGlobalTableStat &stat);

  int get_table_stat(const uint64_t tab_ref_id,
                     const ObIArray<int64_t> &part_ids,
                     const double scale_ratio,
                     ObGlobalTableStat &stat);

  int get_table_stat(const uint64_t table_id,
                     const ObIArray<int64_t> &part_ids,
  ...
  int delete_table_stat(const uint64_t ref_id,
                        const ObIArray<int64_t> &part_ids,
                        const bool cascade_column,
                        const int64_t degree,
                        int64_t &affected_rows);

  int delete_column_stat(const uint64_t ref_id,
                         const ObIArray<uint64_t> &column_ids,
                         const ObIArray<int64_t> &part_ids,
  ...
  int erase_table_stat(const uint64_t table_id,
                       const ObIArray<int64_t> &part_ids);
  int erase_column_stat(const uint64_t table_id,
                        const ObIArray<int64_t> &part_ids,
                        const ObIArray<uint64_t> &column_ids);
  ...
  int update_system_stats(const ObOptSystemStat *system_stats);
