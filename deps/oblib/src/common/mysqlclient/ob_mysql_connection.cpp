...
#include "common/mysqlclient/ob_mysql_read_context.h"
namespace oceanbase { namespace share { namespace schema { class ObRoutineInfo; } } }  // forward declaration: reference-only pass-through
